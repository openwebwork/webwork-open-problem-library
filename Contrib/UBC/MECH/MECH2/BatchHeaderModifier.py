# This is the most comprehensive batch header modifier in this whole folder (MECH2) and is the one which should be used. Simply drop in the directory whose files need different headers and include a new text file with the new header which is desired . Check in the subfolders for examples of such text documents
...
# this one is still a prototyep and is currently being developed and tested
    ...
    with open(files) as getHeaders:
        ...
        if subject_flag == 1:
            ...
            local_DBsubject = ""
            print("local_DBsubject in " + files + "\n")
    ...
    with open('LinearAlgebra2017Headerformat.txt') as newHeader:
